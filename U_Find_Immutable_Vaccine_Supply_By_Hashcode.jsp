...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">Developing Intelligent and Immutable Vaccine Supply and Operation Platform Using Blockchain and Artificial Intelligence Technologies
          <br />
        </a></h1>
      </div>
      <div class="menu_nav">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 >Accessed Immutable Vaccine Supply By Blockchain Hashcode !!!</h2>
          <div class="clr"></div>
...
<table width="423" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="217" height="50" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10">Select Caccine Name </div></td>
...
<td height="30" colspan="2" id="learn_more" align="center"  style="color:#FFFFFF;"><p>&nbsp;
  ...
  <p>
    <input type="submit" value="Find Immutable Vaccine Supply Details" style="width:400px; height:25px; background-color:#000000; color:#FFFFFF;"/>
    <br />
  </p></td>
</tr></div>
		  </table>
