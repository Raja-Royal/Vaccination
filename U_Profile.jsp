        ...
        <div class="article">
          ...
          <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <tr>
              ...
              <td  width="158" valign="middle" style="color:#000000;"><div align="left" class="style40 style10 style62 style4 style3" style="margin-left:10px;"><strong>
                  <%out.println(s1);%>
              </strong></div></td>
            </tr>
            <tr>
              ...
              <td  width="158" valign="middle" ><div align="left" class="style40 style10 style62 style4 style3" style="margin-left:10px;"><strong>
                  <%out.println(s2);%>
              </strong></div></td>
            </tr>
            <tr>
              ...
              <td align="left" valign="middle"><div align="left" class="style40 style10 style62 style4 style3" style="margin-left:10px;"><strong>
                  <%out.println(s3);%>
              </strong></div></td>
            </tr>
            <tr>
              ...
              <td  width="158" align="left" valign="middle"><div align="left" class="style40 style10 style62 style4 style3" style="margin-left:10px;"><strong>
                  <%out.println(s4);%>
              </strong></div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td  width="158" align="left" valign="middle" style="color: #2c83b0;"><div align="left">
                  <div align="left" class="style10 style62 style4 style3" style="margin-left:10px;"><strong>
                    <%out.println(s6);%>
              </strong></div></td>
            </tr>
            <%
