...
<head>
<title>A_View_Supplied_Vaccines_LogisticName_Results</title>
  ...
  <div>
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2>&nbsp;</h2>
        <h2><span class="style2">View Supplied Vaccines Logistic Name Results !!!...</span></h2>
        <div class="clr"></div>
          <div align="justify">
                  <p>&nbsp;</p>
                  <iframe width="900" height="650" src="Results1.jsp"></iframe><p>&nbsp;</p>
