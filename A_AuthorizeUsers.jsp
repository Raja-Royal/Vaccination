...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style4">Admin Authorized Users</span></h2>
         <table width="913" align="center"  cellpadding="0" cellspacing="0" >
            ...
            <%
					...
					%>
            <tr bgcolor="#99CCFF">
              <td height="122" align="center"  valign="middle" bgcolor="#FF0000"><div align="center" class="style6 style71 style70 style37 style54 style55 style86 style57"><strong>
                  <%out.println(i);%>
              </strong></div></td>
              <td  rowspan="1" align="center" valign="middle" bgcolor="#FF0000" ><div class="style6 style71 style70 style37 style54 style55 style86 style57" style="margin:10px 13px 10px 13px;" ><strong>
                  <input  name="image" type="image" src="images.jsp?id=<%=i%>" style="width:120px; height:100px;" />
              </strong></div></td>
              <td  align="center"  valign="middle" bgcolor="#FF0000"><div align="center" class="style6 style71 style70 style20 style37 style54 style55 style86 style57"><strong>
                  <%out.println(s1);%>
              </strong></div></td>
              <td  align="center"  valign="middle" bgcolor="#FF0000"><div align="center" class="style6 style71 style70 style20 style37 style54 style55 style86 style57"><strong>
                  <%out.println(s2);%>
			  ...
			  <td  align="center"  valign="middle" bgcolor="#FF0000"><div align="center" class="style6 style71 style70 style20 style37 style54 style55 style86 style57"><strong>
               ...
               <%
						...
						%>
              <td align="center" valign="middle" bgcolor="#FF0000"  style="color:#000000;"><div align="center" class="style20 style30 style37 style86 style70 style71 style6 style7">
              ...
              <%
						...
						{
						%>
              <td width="76" align="center"  valign="middle" bgcolor="#FF0000"><div align="center" class="style6 style72 style71 style30 style55 style37 style20"><strong>
                  <%out.println(s4);%>
              </strong></div></td>
              <%
						}
